// Adapted from https://github.com/philippgille/gokv.
package kvstore
...
type Store interface {
	...
	Get(ctx context.Context, k string, v any) (found bool, err error)
	...
	// but as long as you work with the Store interface you never know which implementation
