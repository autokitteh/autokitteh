...
require (
	...
	github.com/descope/go-sdk v1.6.6
...
require (
	ariga.io/atlas-go-sdk v0.5.8 // indirect
	...
	github.com/open-policy-agent/contrib/logging/plugins/ozap v0.0.0-20241029162737-15646de6bd2b // indirect
