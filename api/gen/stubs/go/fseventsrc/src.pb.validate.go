...
// Validate checks the field values on Ops with the rules defined in the proto
...
func (m *Ops) Validate() error {
	...
	// no validation rules for Write

	// no validation rules for Remove

	// no validation rules for Rename

	// no validation rules for Chmod

	return nil
}

// OpsValidationError is the validation error returned by Ops.Validate if the
...
func (e OpsValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e OpsValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e OpsValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e OpsValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e OpsValidationError) ErrorName() string { return "OpsValidationError" }
...
var _ error = OpsValidationError{}
...
func (m *BindRequest) Validate() error {
	...
	if v, ok := interface{}(m.GetOps()).(interface{ Validate() error }); ok {
