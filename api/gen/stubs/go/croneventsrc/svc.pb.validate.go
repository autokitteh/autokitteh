...
func (m *BindRequest) Validate() error {
	...
	if utf8.RuneCountInString(m.GetCronspec()) < 1 {
		return BindRequestValidationError{
			field:  "Cronspec",
...
// Validate checks the field values on TickResponse with the rules defined in
// the proto definition for this message. If any rules are violated, an error
// is returned.
...
// TickResponseValidationError is the validation error returned by
// TickResponse.Validate if the designated constraints aren't met.
...
// Field function returns field value.
func (e TickResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e TickResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e TickResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e TickResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e TickResponseValidationError) ErrorName() string { return "TickResponseValidationError" }
...
var _ error = TickResponseValidationError{}
