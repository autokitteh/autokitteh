...
class StartRequest(_message.Message):
    ...
    def __init__(self, entry_point: _Optional[str] = ..., event: _Optional[_Union[_types_pb2.Event, _Mapping]] = ...) -> None: ...
...
class ExecuteResponse(_message.Message):
    ...
    def __init__(self, result: _Optional[bytes] = ..., error: _Optional[str] = ..., traceback: _Optional[_Iterable[_Union[_types_pb2.Frame, _Mapping]]] = ...) -> None: ...
...
class StartResponse(_message.Message):
    ...
    error: str
    traceback: _containers.RepeatedCompositeFieldContainer[_types_pb2.Frame]
    def __init__(self, error: _Optional[str] = ..., traceback: _Optional[_Iterable[_Union[_types_pb2.Frame, _Mapping]]] = ...) -> None: ...
...
class UserCodeRunnerHealthRequest(_message.Message):
    __slots__ = []
    def __init__(self) -> None: ...

class UserCodeRunnerHealthResponse(_message.Message):
    __slots__ = ["error"]
    ERROR_FIELD_NUMBER: _ClassVar[int]
    error: str
    def __init__(self, error: _Optional[str] = ...) -> None: ...
