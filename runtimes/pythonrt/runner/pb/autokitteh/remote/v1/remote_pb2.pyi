...
class DoneRequest(_message.Message):
    ...
    error: str
    traceback: _containers.RepeatedCompositeFieldContainer[Frame]
    def __init__(self, runner_id: _Optional[str] = ..., result: _Optional[_Union[_values_pb2.Value, _Mapping]] = ..., error: _Optional[str] = ..., traceback: _Optional[_Iterable[_Union[Frame, _Mapping]]] = ...) -> None: ...
