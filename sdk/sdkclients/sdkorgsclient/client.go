...
func (c *client) GetOrgsForUser(ctx context.Context, uid sdktypes.UserID) ([]sdktypes.OrgID, error) {
	...
	return kittehs.TransformError(resp.Msg.OrgIds, sdktypes.StrictParseOrgID)
}
