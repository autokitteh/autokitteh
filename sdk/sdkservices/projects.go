...
type Projects interface {
	...
	GetByName(ctx context.Context, oid sdktypes.OwnerID, name sdktypes.Symbol) (sdktypes.Project, error)
	List(ctx context.Context, oid sdktypes.OwnerID) ([]sdktypes.Project, error)
