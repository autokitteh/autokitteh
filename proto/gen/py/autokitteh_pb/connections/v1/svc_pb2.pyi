...
class ListRequest(_message.Message):
    __slots__ = ["integration_id", "project_id", "status_code", "owner_id"]
    ...
    owner_id: str
    def __init__(self, integration_id: _Optional[str] = ..., project_id: _Optional[str] = ..., status_code: _Optional[_Union[_status_pb2.Status.Code, str]] = ..., owner_id: _Optional[str] = ...) -> None: ...
