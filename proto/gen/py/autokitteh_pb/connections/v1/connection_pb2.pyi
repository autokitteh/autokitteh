...
class Connection(_message.Message):
    __slots__ = ["connection_id", "integration_id", "project_id", "name", "status", "capabilities", "links", "target", "org_id"]
