...
class ListRequest(_message.Message):
    __slots__ = ["deployment_id", "project_id", "event_id", "build_id", "state_type", "owner_id", "count_only", "page_size", "skip", "page_token"]
    ...
    skip: int
    page_token: str
    def __init__(self, deployment_id: _Optional[str] = ..., project_id: _Optional[str] = ..., event_id: _Optional[str] = ..., build_id: _Optional[str] = ..., state_type: _Optional[_Union[_session_pb2.SessionStateType, str]] = ..., owner_id: _Optional[str] = ..., count_only: bool = ..., page_size: _Optional[int] = ..., skip: _Optional[int] = ..., page_token: _Optional[str] = ...) -> None: ...
