...
class Session(_message.Message):
    __slots__ = ["session_id", "deployment_id", "build_id", "event_id", "entrypoint", "inputs", "parent_session_id", "memo", "created_at", "updated_at", "state"]
