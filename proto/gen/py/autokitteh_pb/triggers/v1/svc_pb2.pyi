...
class ListRequest(_message.Message):
    __slots__ = ["connection_id", "project_id", "source_type", "owner_id"]
    ...
    owner_id: str
    def __init__(self, connection_id: _Optional[str] = ..., project_id: _Optional[str] = ..., source_type: _Optional[_Union[_trigger_pb2.Trigger.SourceType, str]] = ..., owner_id: _Optional[str] = ...) -> None: ...
