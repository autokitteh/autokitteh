...
class Trigger(_message.Message):
    __slots__ = ["trigger_id", "name", "connection_id", "env_id", "event_type", "code_location", "filter", "data", "trigger_type"]
    ...
    trigger_type: str
    def __init__(self, trigger_id: _Optional[str] = ..., name: _Optional[str] = ..., connection_id: _Optional[str] = ..., env_id: _Optional[str] = ..., event_type: _Optional[str] = ..., code_location: _Optional[_Union[_program_pb2.CodeLocation, _Mapping]] = ..., filter: _Optional[str] = ..., data: _Optional[_Mapping[str, _values_pb2.Value]] = ..., trigger_type: _Optional[str] = ...) -> None: ...
