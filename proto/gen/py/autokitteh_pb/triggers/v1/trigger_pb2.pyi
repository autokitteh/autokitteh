...
class Trigger(_message.Message):
    __slots__ = ["trigger_id", "name", "source_type", "project_id", "event_type", "code_location", "filter", "is_durable", "is_sync", "connection_id", "schedule", "webhook_auth_required", "webhook_slug"]
    ...
    WEBHOOK_AUTH_REQUIRED_FIELD_NUMBER: _ClassVar[int]
