...
class Trigger(_message.Message):
    __slots__ = ["trigger_id", "name", "source_type", "project_id", "event_type", "code_location", "filter", "is_durable", "connection_id", "schedule", "webhook_slug"]
