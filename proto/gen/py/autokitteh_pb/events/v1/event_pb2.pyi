...
class Event(_message.Message):
    __slots__ = ["event_id", "connection_id", "event_type", "data", "memo", "created_at", "seq"]
    ...
    created_at: _timestamp_pb2.Timestamp
    seq: int
    def __init__(self, event_id: _Optional[str] = ..., connection_id: _Optional[str] = ..., event_type: _Optional[str] = ..., data: _Optional[_Mapping[str, _values_pb2.Value]] = ..., memo: _Optional[_Mapping[str, str]] = ..., created_at: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., seq: _Optional[int] = ...) -> None: ...
