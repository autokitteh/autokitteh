...
class ListRequest(_message.Message):
    __slots__ = ["integration_id", "destination_id", "event_type", "max_results", "order", "json_values", "project_id"]
    ...
    json_values: bool
    project_id: str
    def __init__(self, integration_id: _Optional[str] = ..., destination_id: _Optional[str] = ..., event_type: _Optional[str] = ..., max_results: _Optional[int] = ..., order: _Optional[str] = ..., json_values: bool = ..., project_id: _Optional[str] = ...) -> None: ...
