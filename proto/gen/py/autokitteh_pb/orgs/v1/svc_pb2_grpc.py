...
class OrgsServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ListUserMemberships = channel.unary_unary(
                '/autokitteh.orgs.v1.OrgsService/ListUserMemberships',
                request_serializer=autokitteh_dot_orgs_dot_v1_dot_svc__pb2.ListUserMembershipsRequest.SerializeToString,
                response_deserializer=autokitteh_dot_orgs_dot_v1_dot_svc__pb2.ListUserMembershipsResponse.FromString,
                )
...
def add_OrgsServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ListUserMemberships': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=autokitteh_dot_orgs_dot_v1_dot_svc__pb2.ListUserMembershipsRequest.FromString,
                    response_serializer=autokitteh_dot_orgs_dot_v1_dot_svc__pb2.ListUserMembershipsResponse.SerializeToString,
            ),
    }
...
class OrgsService(object):
    ...
    def ListUserMemberships(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/autokitteh.orgs.v1.OrgsService/ListUserMemberships',
            autokitteh_dot_orgs_dot_v1_dot_svc__pb2.ListUserMembershipsRequest.SerializeToString,
            autokitteh_dot_orgs_dot_v1_dot_svc__pb2.ListUserMembershipsResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
