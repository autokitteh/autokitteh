...
// Bitfield.
type SessionLogRecord_Type int32
...
const (
	...
	SessionLogRecord_TYPE_STATE                 SessionLogRecord_Type = 16
	SessionLogRecord_TYPE_STOP_REQUEST          SessionLogRecord_Type = 32
	SessionLogRecord_TYPE_HTTP_RESPONSE         SessionLogRecord_Type = 64
)

// Enum value maps for SessionLogRecord_Type.
var (
	SessionLogRecord_Type_name = map[int32]string{
		0:  "TYPE_UNSPECIFIED",
		1:  "TYPE_PRINT",
		2:  "TYPE_CALL_SPEC",
		4:  "TYPE_CALL_ATTEMPT_START",
		8:  "TYPE_CALL_ATTEMPT_COMPLETE",
		16: "TYPE_STATE",
		32: "TYPE_STOP_REQUEST",
		64: "TYPE_HTTP_RESPONSE",
	}
	SessionLogRecord_Type_value = map[string]int32{
		"TYPE_UNSPECIFIED":           0,
		"TYPE_PRINT":                 1,
		"TYPE_CALL_SPEC":             2,
		...
		"TYPE_HTTP_RESPONSE":         64,
	}
)

func (x SessionLogRecord_Type) Enum() *SessionLogRecord_Type {
	p := new(SessionLogRecord_Type)
	*p = x
	return p
}

func (x SessionLogRecord_Type) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (SessionLogRecord_Type) Descriptor() protoreflect.EnumDescriptor {
	return file_autokitteh_sessions_v1_session_proto_enumTypes[1].Descriptor()
}

func (SessionLogRecord_Type) Type() protoreflect.EnumType {
	return &file_autokitteh_sessions_v1_session_proto_enumTypes[1]
}

func (x SessionLogRecord_Type) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use SessionLogRecord_Type.Descriptor instead.
func (SessionLogRecord_Type) EnumDescriptor() ([]byte, []int) {
...
type SessionLogRecord struct {
	...
	HttpResponse        *SessionLogRecord_HTTPResponse `protobuf:"bytes,16,opt,name=http_response,json=httpResponse,proto3" json:"http_response,omitempty"`
}
...
func (x *SessionLogRecord) GetHttpResponse() *SessionLogRecord_HTTPResponse {
	if x != nil {
...
type Call_Attempt_Complete struct {
	...
	RetryInterval *durationpb.Duration   `protobuf:"bytes,2,opt,name=retry_interval,json=retryInterval,proto3" json:"retry_interval,omitempty"` // deprecated.
...
type SessionLogRecord_Print struct {
	...
	Text  string     `protobuf:"bytes,1,opt,name=text,proto3" json:"text,omitempty"` // deprecated, use value instead.
	Value *v11.Value `protobuf:"bytes,2,opt,name=value,proto3" json:"value,omitempty"`
	// for prints that happened inside an activity.
	CallSeq uint32 `protobuf:"varint,3,opt,name=call_seq,json=callSeq,proto3" json:"call_seq,omitempty"`
}
...
func (x *SessionLogRecord_Print) GetValue() *v11.Value {
	if x != nil {
		return x.Value
	}
	return nil
...
func (x *SessionLogRecord_Print) GetCallSeq() uint32 {
	if x != nil {
		return x.CallSeq
	}
	return 0
...
type SessionLogRecord_HTTPResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	StatusCode uint32            `protobuf:"varint,1,opt,name=status_code,json=statusCode,proto3" json:"status_code,omitempty"`                                                                // Must always be present at first response. Ignored after. If set to 0, default to 200.
	Headers    map[string]string `protobuf:"bytes,2,rep,name=headers,proto3" json:"headers,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // Ignored if not specified at first response.
	Body       []byte            `protobuf:"bytes,3,opt,name=body,proto3" json:"body,omitempty"`
	More       bool              `protobuf:"varint,4,opt,name=more,proto3" json:"more,omitempty"` // if false, this is the final response and the HTTP connection should be closed.
}

func (x *SessionLogRecord_HTTPResponse) Reset() {
	*x = SessionLogRecord_HTTPResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *SessionLogRecord_HTTPResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SessionLogRecord_HTTPResponse) ProtoMessage() {}

func (x *SessionLogRecord_HTTPResponse) ProtoReflect() protoreflect.Message {
	mi := &file_autokitteh_sessions_v1_session_proto_msgTypes[18]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SessionLogRecord_HTTPResponse.ProtoReflect.Descriptor instead.
func (*SessionLogRecord_HTTPResponse) Descriptor() ([]byte, []int) {
	return file_autokitteh_sessions_v1_session_proto_rawDescGZIP(), []int{2, 2}
}

func (x *SessionLogRecord_HTTPResponse) GetStatusCode() uint32 {
	if x != nil {
		return x.StatusCode
	}
	return 0
...
func (x *SessionLogRecord_HTTPResponse) GetHeaders() map[string]string {
	if x != nil {
		return x.Headers
	}
	return nil
...
func (x *SessionLogRecord_HTTPResponse) GetBody() []byte {
	if x != nil {
		return x.Body
	}
	return nil
...
func (x *SessionLogRecord_HTTPResponse) GetMore() bool {
	if x != nil {
		return x.More
	}
	return false
...
var file_autokitteh_sessions_v1_session_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0x88, 0x07, 0x0a, 0x0c, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e,
	...
	0x6f, 0x72, 0x1a, 0xa7, 0x02, 0x0a, 0x09, 0x43, 0x6f, 0x6d, 0x70, 0x6c, 0x65, 0x74, 0x65, 0x64,
	...
	0x72, 0x74, 0x73, 0x12, 0x3e, 0x0a, 0x0c, 0x72, 0x65, 0x74, 0x75, 0x72, 0x6e, 0x5f, 0x76, 0x61,
	...
	0x2e, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x52, 0x0b, 0x72, 0x65, 0x74, 0x75, 0x72, 0x6e, 0x56, 0x61,
	0x6c, 0x75, 0x65, 0x1a, 0x57, 0x0a, 0x0c, 0x45, 0x78, 0x70, 0x6f, 0x72, 0x74, 0x73, 0x45, 0x6e,
	...
	,
	...
	0x42, 0x07, 0xfa, 0xf7, 0x18, 0x03, 0xc8, 0x01, 0x01, 0x52, 0x08, 0x66, 0x75, 0x6e, 0x63, 0x74,
	0x69, 0x6f, 0x6e, 0x12, 0x3d, 0x0a, 0x04, 0x61, 0x72, 0x67, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28,
	0x0b, 0x32, 0x1b, 0x2e, 0x61, 0x75, 0x74, 0x6f, 0x6b, 0x69, 0x74, 0x74, 0x65, 0x68, 0x2e, 0x76,
	0x61, 0x6c, 0x75, 0x65, 0x73, 0x2e, 0x76, 0x31, 0x2e, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x42, 0x0c,
	0xfa, 0xf7, 0x18, 0x08, 0x92, 0x01, 0x05, 0x22, 0x03, 0xc8, 0x01, 0x01, 0x52, 0x04, 0x61, 0x72,
	0x67, 0x73, 0x12, 0x59, 0x0a, 0x06, 0x6b, 0x77, 0x61, 0x72, 0x67, 0x73, 0x18, 0x03, 0x20, 0x03,
	...
	0x2e, 0x53, 0x70, 0x65, 0x63, 0x2e, 0x4b, 0x77, 0x61, 0x72, 0x67, 0x73, 0x45, 0x6e, 0x74, 0x72,
	0x79, 0x42, 0x12, 0xfa, 0xf7, 0x18, 0x0e, 0x9a, 0x01, 0x0b, 0x22, 0x04, 0x72, 0x02, 0x10, 0x01,
	0x2a, 0x03, 0xc8, 0x01, 0x01, 0x52, 0x06, 0x6b, 0x77, 0x61, 0x72, 0x67, 0x73, 0x12, 0x10, 0x0a,
	0x03, 0x73, 0x65, 0x71, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x03, 0x73, 0x65, 0x71, 0x1a,
	0x56, 0x0a, 0x0b, 0x4b, 0x77, 0x61, 0x72, 0x67, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x10,
	...
	,
	...
	0x72, 0x1a, 0x5d, 0x0a, 0x05, 0x53, 0x74, 0x61, 0x72, 0x74, 0x12, 0x42, 0x0a, 0x0a, 0x73, 0x74,
	...
	,
	...
	0x6e, 0x74, 0x65, 0x72, 0x76, 0x61, 0x6c, 0x12, 0x17, 0x0a, 0x07, 0x69, 0x73, 0x5f, 0x6c, 0x61,
	...
	,
	...
	,
	...
	0x65, 0x52, 0x13, 0x63, 0x61, 0x6c, 0x6c, 0x41, 0x74, 0x74, 0x65, 0x6d, 0x70, 0x74, 0x43, 0x6f,
	0x6d, 0x70, 0x6c, 0x65, 0x74, 0x65, 0x12, 0x3a, 0x0a, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x18,
	0x0e, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x24, 0x2e, 0x61, 0x75, 0x74, 0x6f, 0x6b, 0x69, 0x74, 0x74,
	...
	0x74, 0x65, 0x12, 0x57, 0x0a, 0x0c, 0x73, 0x74, 0x6f, 0x70, 0x5f, 0x72, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x34, 0x2e, 0x61, 0x75, 0x74, 0x6f, 0x6b,
	...
	,
	...
	0x0a, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x43, 0x6f, 0x64, 0x65, 0x12, 0x5c, 0x0a, 0x07, 0x68,
	0x65, 0x61, 0x64, 0x65, 0x72, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x42, 0x2e, 0x61,
	0x75, 0x74, 0x6f, 0x6b, 0x69, 0x74, 0x74, 0x65, 0x68, 0x2e, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f,
	0x6e, 0x73, 0x2e, 0x76, 0x31, 0x2e, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x4c, 0x6f, 0x67,
	0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x2e, 0x48, 0x54, 0x54, 0x50, 0x52, 0x65, 0x73, 0x70, 0x6f,
	...
	0x04, 0x6d, 0x6f, 0x72, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x08, 0x52, 0x04, 0x6d, 0x6f, 0x72,
	...
	0x54, 0x59, 0x50, 0x45, 0x5f, 0x50, 0x52, 0x49, 0x4e, 0x54, 0x10, 0x01, 0x12, 0x12, 0x0a, 0x0e,
	0x54, 0x59, 0x50, 0x45, 0x5f, 0x43, 0x41, 0x4c, 0x4c, 0x5f, 0x53, 0x50, 0x45, 0x43, 0x10, 0x02,
	0x12, 0x1b, 0x0a, 0x17, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x43, 0x41, 0x4c, 0x4c, 0x5f, 0x41, 0x54,
	0x54, 0x45, 0x4d, 0x50, 0x54, 0x5f, 0x53, 0x54, 0x41, 0x52, 0x54, 0x10, 0x04, 0x12, 0x1e, 0x0a,
	0x1a, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x43, 0x41, 0x4c, 0x4c, 0x5f, 0x41, 0x54, 0x54, 0x45, 0x4d,
	...
	0x53, 0x54, 0x10, 0x20, 0x12, 0x16, 0x0a, 0x12, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x48, 0x54, 0x54,
	0x50, 0x5f, 0x52, 0x45, 0x53, 0x50, 0x4f, 0x4e, 0x53, 0x45, 0x10, 0x40, 0x22, 0xfb, 0x05, 0x0a,
	...
	0x73, 0x73, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x12, 0x19, 0x0a, 0x08, 0x62, 0x75, 0x69, 0x6c, 0x64,
	...
	,
	...
	0x6f, 0x6e, 0x49, 0x64, 0x12, 0x3d, 0x0a, 0x04, 0x6d, 0x65, 0x6d, 0x6f, 0x18, 0x07, 0x20, 0x03,
	0x28, 0x0b, 0x32, 0x29, 0x2e, 0x61, 0x75, 0x74, 0x6f, 0x6b, 0x69, 0x74, 0x74, 0x65, 0x68, 0x2e,
	0x73, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x76, 0x31, 0x2e, 0x53, 0x65, 0x73, 0x73,
	0x69, 0x6f, 0x6e, 0x2e, 0x4d, 0x65, 0x6d, 0x6f, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x04, 0x6d,
	...
	,
	...
	,
...
var file_autokitteh_sessions_v1_session_proto_msgTypes = make([]protoimpl.MessageInfo, 22)
var file_autokitteh_sessions_v1_session_proto_goTypes = []interface{}{
	...
	(*SessionLogRecord_HTTPResponse)(nil), // 20: autokitteh.sessions.v1.SessionLogRecord.HTTPResponse
	nil,                                   // 21: autokitteh.sessions.v1.SessionLogRecord.HTTPResponse.HeadersEntry
	nil,                                   // 22: autokitteh.sessions.v1.Session.InputsEntry
	nil,                                   // 23: autokitteh.sessions.v1.Session.MemoEntry
	(*timestamppb.Timestamp)(nil),         // 24: google.protobuf.Timestamp
	(*v1.CodeLocation)(nil),               // 25: autokitteh.program.v1.CodeLocation
	(*v11.Value)(nil),                     // 26: autokitteh.values.v1.Value
	(*v1.Error)(nil),                      // 27: autokitteh.program.v1.Error
...
var file_autokitteh_sessions_v1_session_proto_depIdxs = []int32{
	...
	24, // 7: autokitteh.sessions.v1.SessionLogRecord.t:type_name -> google.protobuf.Timestamp
	...
	20, // 14: autokitteh.sessions.v1.SessionLogRecord.http_response:type_name -> autokitteh.sessions.v1.SessionLogRecord.HTTPResponse
	25, // 15: autokitteh.sessions.v1.Session.entrypoint:type_name -> autokitteh.program.v1.CodeLocation
	22, // 16: autokitteh.sessions.v1.Session.inputs:type_name -> autokitteh.sessions.v1.Session.InputsEntry
	23, // 17: autokitteh.sessions.v1.Session.memo:type_name -> autokitteh.sessions.v1.Session.MemoEntry
	24, // 18: autokitteh.sessions.v1.Session.created_at:type_name -> google.protobuf.Timestamp
	24, // 19: autokitteh.sessions.v1.Session.updated_at:type_name -> google.protobuf.Timestamp
	0,  // 20: autokitteh.sessions.v1.Session.state:type_name -> autokitteh.sessions.v1.SessionStateType
	26, // 21: autokitteh.sessions.v1.SessionState.Running.call:type_name -> autokitteh.values.v1.Value
	27, // 22: autokitteh.sessions.v1.SessionState.Error.error:type_name -> autokitteh.program.v1.Error
	...
	26, // 24: autokitteh.sessions.v1.SessionState.Completed.return_value:type_name -> autokitteh.values.v1.Value
	26, // 25: autokitteh.sessions.v1.SessionState.Completed.ExportsEntry.value:type_name -> autokitteh.values.v1.Value
	26, // 26: autokitteh.sessions.v1.Call.Spec.function:type_name -> autokitteh.values.v1.Value
	26, // 27: autokitteh.sessions.v1.Call.Spec.args:type_name -> autokitteh.values.v1.Value
	...
	26, // 31: autokitteh.sessions.v1.Call.Spec.KwargsEntry.value:type_name -> autokitteh.values.v1.Value
	26, // 32: autokitteh.sessions.v1.Call.Attempt.Result.value:type_name -> autokitteh.values.v1.Value
	27, // 33: autokitteh.sessions.v1.Call.Attempt.Result.error:type_name -> autokitteh.program.v1.Error
	24, // 34: autokitteh.sessions.v1.Call.Attempt.Start.started_at:type_name -> google.protobuf.Timestamp
	24, // 35: autokitteh.sessions.v1.Call.Attempt.Complete.completed_at:type_name -> google.protobuf.Timestamp
	28, // 36: autokitteh.sessions.v1.Call.Attempt.Complete.retry_interval:type_name -> google.protobuf.Duration
	15, // 37: autokitteh.sessions.v1.Call.Attempt.Complete.result:type_name -> autokitteh.sessions.v1.Call.Attempt.Result
	26, // 38: autokitteh.sessions.v1.SessionLogRecord.Print.value:type_name -> autokitteh.values.v1.Value
	21, // 39: autokitteh.sessions.v1.SessionLogRecord.HTTPResponse.headers:type_name -> autokitteh.sessions.v1.SessionLogRecord.HTTPResponse.HeadersEntry
	26, // 40: autokitteh.sessions.v1.Session.InputsEntry.value:type_name -> autokitteh.values.v1.Value
...
func file_autokitteh_sessions_v1_session_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_autokitteh_sessions_v1_session_proto_msgTypes[18].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SessionLogRecord_HTTPResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
