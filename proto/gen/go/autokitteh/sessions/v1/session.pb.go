...
type SessionState struct {
	...
	//
	//	*SessionState_Created_
	//	*SessionState_Running_
	//	*SessionState_Error_
	//	*SessionState_Completed_
	States isSessionState_States `protobuf_oneof:"states"`
}
...
func (x *SessionState) GetT() *timestamppb.Timestamp {
	if x != nil {
		return x.T
	}
	return nil
...
func (m *SessionState) GetStates() isSessionState_States {
	if m != nil {
		return m.States
	}
	return nil
...
func (x *SessionState) GetCreated() *SessionState_Created {
	if x, ok := x.GetStates().(*SessionState_Created_); ok {
		return x.Created
	}
	return nil
}
...
func (x *SessionState) GetRunning() *SessionState_Running {
	if x, ok := x.GetStates().(*SessionState_Running_); ok {
		return x.Running
	}
	return nil
}
...
func (x *SessionState) GetError() *SessionState_Error {
	if x, ok := x.GetStates().(*SessionState_Error_); ok {
		return x.Error
	}
	return nil
}
...
func (x *SessionState) GetCompleted() *SessionState_Completed {
	if x, ok := x.GetStates().(*SessionState_Completed_); ok {
		return x.Completed
	}
	return nil
}

type isSessionState_States interface {
	isSessionState_States()
}

type SessionState_Created_ struct {
	Created *SessionState_Created `protobuf:"bytes,10,opt,name=created,proto3,oneof"`
}

type SessionState_Running_ struct {
	Running *SessionState_Running `protobuf:"bytes,11,opt,name=running,proto3,oneof"`
}

type SessionState_Error_ struct {
	Error *SessionState_Error `protobuf:"bytes,12,opt,name=error,proto3,oneof"`
}

type SessionState_Completed_ struct {
	Completed *SessionState_Completed `protobuf:"bytes,13,opt,name=completed,proto3,oneof"`
}

func (*SessionState_Created_) isSessionState_States() {}

func (*SessionState_Running_) isSessionState_States() {}

func (*SessionState_Error_) isSessionState_States() {}

func (*SessionState_Completed_) isSessionState_States() {}
...
type SessionLogRecord struct {
	...
	//
	//	*SessionLogRecord_Print
	//	*SessionLogRecord_CallSpec
	//	*SessionLogRecord_CallAttemptStart
	//	*SessionLogRecord_CallAttemptComplete
	//	*SessionLogRecord_State
	Data isSessionLogRecord_Data `protobuf_oneof:"data"`
}
...
func (m *SessionLogRecord) GetData() isSessionLogRecord_Data {
	if m != nil {
		return m.Data
	}
	return nil
...
func (x *SessionLogRecord) GetPrint() string {
	if x, ok := x.GetData().(*SessionLogRecord_Print); ok {
		return x.Print
	}
	return ""
}
...
func (x *SessionLogRecord) GetCallSpec() *Call_Spec {
	if x, ok := x.GetData().(*SessionLogRecord_CallSpec); ok {
		return x.CallSpec
	}
	return nil
}
...
func (x *SessionLogRecord) GetCallAttemptStart() *Call_Attempt_Start {
	if x, ok := x.GetData().(*SessionLogRecord_CallAttemptStart); ok {
...
func (x *SessionLogRecord) GetCallAttemptComplete() *Call_Attempt_Complete {
	if x, ok := x.GetData().(*SessionLogRecord_CallAttemptComplete); ok {
...
func (x *SessionLogRecord) GetState() *SessionState {
	if x, ok := x.GetData().(*SessionLogRecord_State); ok {
		return x.State
	}
	return nil
}

type isSessionLogRecord_Data interface {
	isSessionLogRecord_Data()
}

type SessionLogRecord_Print struct {
	Print string `protobuf:"bytes,10,opt,name=print,proto3,oneof"`
}

type SessionLogRecord_CallSpec struct {
	CallSpec *Call_Spec `protobuf:"bytes,11,opt,name=call_spec,json=callSpec,proto3,oneof"`
}

type SessionLogRecord_CallAttemptStart struct {
	CallAttemptStart *Call_Attempt_Start `protobuf:"bytes,12,opt,name=call_attempt_start,json=callAttemptStart,proto3,oneof"`
}

type SessionLogRecord_CallAttemptComplete struct {
	CallAttemptComplete *Call_Attempt_Complete `protobuf:"bytes,13,opt,name=call_attempt_complete,json=callAttemptComplete,proto3,oneof"`
}

type SessionLogRecord_State struct {
	State *SessionState `protobuf:"bytes,14,opt,name=state,proto3,oneof"`
}

func (*SessionLogRecord_Print) isSessionLogRecord_Data() {}

func (*SessionLogRecord_CallSpec) isSessionLogRecord_Data() {}

func (*SessionLogRecord_CallAttemptStart) isSessionLogRecord_Data() {}

func (*SessionLogRecord_CallAttemptComplete) isSessionLogRecord_Data() {}

func (*SessionLogRecord_State) isSessionLogRecord_Data() {}
...
type Session struct {
	...
	EventId         string                 `protobuf:"bytes,3,opt,name=event_id,json=eventId,proto3" json:"event_id,omitempty"` // TODO: eliminate? move to inputs? or memo?
...
type Call_Attempt_Result struct {
	...
	//
	//	*Call_Attempt_Result_Value
	//	*Call_Attempt_Result_Error
	Result isCall_Attempt_Result_Result `protobuf_oneof:"result"`
}
...
func (m *Call_Attempt_Result) GetResult() isCall_Attempt_Result_Result {
	if m != nil {
		return m.Result
	}
	return nil
...
func (x *Call_Attempt_Result) GetValue() *v11.Value {
	if x, ok := x.GetResult().(*Call_Attempt_Result_Value); ok {
		return x.Value
	}
	return nil
}
...
func (x *Call_Attempt_Result) GetError() *v1.Error {
	if x, ok := x.GetResult().(*Call_Attempt_Result_Error); ok {
		return x.Error
	}
	return nil
}

type isCall_Attempt_Result_Result interface {
	isCall_Attempt_Result_Result()
}

type Call_Attempt_Result_Value struct {
	Value *v11.Value `protobuf:"bytes,10,opt,name=value,proto3,oneof"`
}

type Call_Attempt_Result_Error struct {
	Error *v1.Error `protobuf:"bytes,11,opt,name=error,proto3,oneof"`
}

func (*Call_Attempt_Result_Value) isCall_Attempt_Result_Result() {}

func (*Call_Attempt_Result_Error) isCall_Attempt_Result_Result() {}
...
var file_autokitteh_sessions_v1_session_proto_rawDesc = []byte{
	...
	,
	...
	0x69, 0x6e, 0x67, 0x12, 0x42, 0x0a, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x18, 0x0c, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x2a, 0x2e, 0x61, 0x75, 0x74, 0x6f, 0x6b, 0x69, 0x74, 0x74, 0x65, 0x68, 0x2e,
	0x73, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x76, 0x31, 0x2e, 0x53, 0x65, 0x73, 0x73,
	0x69, 0x6f, 0x6e, 0x53, 0x74, 0x61, 0x74, 0x65, 0x2e, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x48, 0x00,
	0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x12, 0x4e, 0x0a, 0x09, 0x63, 0x6f, 0x6d, 0x70, 0x6c,
	...
	,
	...
	0x42, 0x07, 0xfa, 0xf7, 0x18, 0x03, 0xc8, 0x01, 0x01, 0x52, 0x0b, 0x72, 0x65, 0x74, 0x75, 0x72,
	0x6e, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x1a, 0x57, 0x0a, 0x0c, 0x45, 0x78, 0x70, 0x6f, 0x72, 0x74,
	...
	,
	...
	,
	...
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x1a, 0xf2, 0x04, 0x0a, 0x07, 0x41, 0x74,
	0x74, 0x65, 0x6d, 0x70, 0x74, 0x12, 0x40, 0x0a, 0x05, 0x73, 0x74, 0x61, 0x72, 0x74, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x2a, 0x2e, 0x61, 0x75, 0x74, 0x6f, 0x6b, 0x69, 0x74, 0x74, 0x65,
	0x68, 0x2e, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x76, 0x31, 0x2e, 0x43, 0x61,
	0x6c, 0x6c, 0x2e, 0x41, 0x74, 0x74, 0x65, 0x6d, 0x70, 0x74, 0x2e, 0x53, 0x74, 0x61, 0x72, 0x74,
	0x52, 0x05, 0x73, 0x74, 0x61, 0x72, 0x74, 0x12, 0x49, 0x0a, 0x08, 0x63, 0x6f, 0x6d, 0x70, 0x6c,
	0x65, 0x74, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2d, 0x2e, 0x61, 0x75, 0x74, 0x6f,
	...
	0x74, 0x65, 0x1a, 0x85, 0x01, 0x0a, 0x06, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x12, 0x33, 0x0a,
	0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1b, 0x2e, 0x61,
	...
	0x75, 0x65, 0x12, 0x34, 0x0a, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x18, 0x0b, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x1c, 0x2e, 0x61, 0x75, 0x74, 0x6f, 0x6b, 0x69, 0x74, 0x74, 0x65, 0x68, 0x2e, 0x70,
	0x72, 0x6f, 0x67, 0x72, 0x61, 0x6d, 0x2e, 0x76, 0x31, 0x2e, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x48,
	0x00, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x42, 0x10, 0x0a, 0x06, 0x72, 0x65, 0x73, 0x75,
	0x6c, 0x74, 0x12, 0x06, 0xfa, 0xf7, 0x18, 0x02, 0x08, 0x01, 0x1a, 0x5d, 0x0a, 0x05, 0x53, 0x74,
	...
	,
	...
	0x65, 0x63, 0x6f, 0x72, 0x64, 0x73, 0x22, 0xcb, 0x05, 0x0a, 0x07, 0x53, 0x65, 0x73, 0x73, 0x69,
	0x6f, 0x6e, 0x12, 0x1d, 0x0a, 0x0a, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x5f, 0x69, 0x64,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x49,
	0x64, 0x12, 0x2d, 0x0a, 0x0d, 0x64, 0x65, 0x70, 0x6c, 0x6f, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x5f,
	0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x42, 0x08, 0xfa, 0xf7, 0x18, 0x04, 0x72, 0x02,
	...
	0x6e, 0x74, 0x72, 0x79, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32,
	...
	,
	...
	0x64, 0x41, 0x74, 0x12, 0x3e, 0x0a, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x18, 0x0c, 0x20, 0x01,
	...
	0x61, 0x74, 0x65, 0x1a, 0x56, 0x0a, 0x0b, 0x49, 0x6e, 0x70, 0x75, 0x74, 0x73, 0x45, 0x6e, 0x74,
	...
	,
...
var file_autokitteh_sessions_v1_session_proto_msgTypes = make([]protoimpl.MessageInfo, 18)
var file_autokitteh_sessions_v1_session_proto_goTypes = []interface{}{
	...
	nil,                            // 10: autokitteh.sessions.v1.SessionState.Completed.ExportsEntry
	(*Call_Spec)(nil),              // 11: autokitteh.sessions.v1.Call.Spec
	(*Call_Attempt)(nil),           // 12: autokitteh.sessions.v1.Call.Attempt
	nil,                            // 13: autokitteh.sessions.v1.Call.Spec.KwargsEntry
	(*Call_Attempt_Result)(nil),    // 14: autokitteh.sessions.v1.Call.Attempt.Result
	(*Call_Attempt_Start)(nil),     // 15: autokitteh.sessions.v1.Call.Attempt.Start
	(*Call_Attempt_Complete)(nil),  // 16: autokitteh.sessions.v1.Call.Attempt.Complete
	nil,                            // 17: autokitteh.sessions.v1.Session.InputsEntry
	nil,                            // 18: autokitteh.sessions.v1.Session.MemoEntry
	(*timestamppb.Timestamp)(nil),  // 19: google.protobuf.Timestamp
	(*v1.CodeLocation)(nil),        // 20: autokitteh.program.v1.CodeLocation
	(*v11.Value)(nil),              // 21: autokitteh.values.v1.Value
	(*v1.Error)(nil),               // 22: autokitteh.program.v1.Error
	(*durationpb.Duration)(nil),    // 23: google.protobuf.Duration
}
var file_autokitteh_sessions_v1_session_proto_depIdxs = []int32{
	19, // 0: autokitteh.sessions.v1.SessionState.t:type_name -> google.protobuf.Timestamp
	6,  // 1: autokitteh.sessions.v1.SessionState.created:type_name -> autokitteh.sessions.v1.SessionState.Created
	7,  // 2: autokitteh.sessions.v1.SessionState.running:type_name -> autokitteh.sessions.v1.SessionState.Running
	8,  // 3: autokitteh.sessions.v1.SessionState.error:type_name -> autokitteh.sessions.v1.SessionState.Error
	9,  // 4: autokitteh.sessions.v1.SessionState.completed:type_name -> autokitteh.sessions.v1.SessionState.Completed
	11, // 5: autokitteh.sessions.v1.Call.spec:type_name -> autokitteh.sessions.v1.Call.Spec
	12, // 6: autokitteh.sessions.v1.Call.attempts:type_name -> autokitteh.sessions.v1.Call.Attempt
	19, // 7: autokitteh.sessions.v1.SessionLogRecord.t:type_name -> google.protobuf.Timestamp
	11, // 8: autokitteh.sessions.v1.SessionLogRecord.call_spec:type_name -> autokitteh.sessions.v1.Call.Spec
	15, // 9: autokitteh.sessions.v1.SessionLogRecord.call_attempt_start:type_name -> autokitteh.sessions.v1.Call.Attempt.Start
	16, // 10: autokitteh.sessions.v1.SessionLogRecord.call_attempt_complete:type_name -> autokitteh.sessions.v1.Call.Attempt.Complete
	1,  // 11: autokitteh.sessions.v1.SessionLogRecord.state:type_name -> autokitteh.sessions.v1.SessionState
	3,  // 12: autokitteh.sessions.v1.SessionLog.records:type_name -> autokitteh.sessions.v1.SessionLogRecord
	20, // 13: autokitteh.sessions.v1.Session.entrypoint:type_name -> autokitteh.program.v1.CodeLocation
	17, // 14: autokitteh.sessions.v1.Session.inputs:type_name -> autokitteh.sessions.v1.Session.InputsEntry
	18, // 15: autokitteh.sessions.v1.Session.memo:type_name -> autokitteh.sessions.v1.Session.MemoEntry
	19, // 16: autokitteh.sessions.v1.Session.created_at:type_name -> google.protobuf.Timestamp
	19, // 17: autokitteh.sessions.v1.Session.updated_at:type_name -> google.protobuf.Timestamp
	0,  // 18: autokitteh.sessions.v1.Session.state:type_name -> autokitteh.sessions.v1.SessionStateType
	21, // 19: autokitteh.sessions.v1.SessionState.Running.call:type_name -> autokitteh.values.v1.Value
	22, // 20: autokitteh.sessions.v1.SessionState.Error.error:type_name -> autokitteh.program.v1.Error
	10, // 21: autokitteh.sessions.v1.SessionState.Completed.exports:type_name -> autokitteh.sessions.v1.SessionState.Completed.ExportsEntry
	21, // 22: autokitteh.sessions.v1.SessionState.Completed.return_value:type_name -> autokitteh.values.v1.Value
	21, // 23: autokitteh.sessions.v1.SessionState.Completed.ExportsEntry.value:type_name -> autokitteh.values.v1.Value
	21, // 24: autokitteh.sessions.v1.Call.Spec.function:type_name -> autokitteh.values.v1.Value
	21, // 25: autokitteh.sessions.v1.Call.Spec.args:type_name -> autokitteh.values.v1.Value
	13, // 26: autokitteh.sessions.v1.Call.Spec.kwargs:type_name -> autokitteh.sessions.v1.Call.Spec.KwargsEntry
	15, // 27: autokitteh.sessions.v1.Call.Attempt.start:type_name -> autokitteh.sessions.v1.Call.Attempt.Start
	16, // 28: autokitteh.sessions.v1.Call.Attempt.complete:type_name -> autokitteh.sessions.v1.Call.Attempt.Complete
	21, // 29: autokitteh.sessions.v1.Call.Spec.KwargsEntry.value:type_name -> autokitteh.values.v1.Value
	21, // 30: autokitteh.sessions.v1.Call.Attempt.Result.value:type_name -> autokitteh.values.v1.Value
	22, // 31: autokitteh.sessions.v1.Call.Attempt.Result.error:type_name -> autokitteh.program.v1.Error
	19, // 32: autokitteh.sessions.v1.Call.Attempt.Start.started_at:type_name -> google.protobuf.Timestamp
	19, // 33: autokitteh.sessions.v1.Call.Attempt.Complete.completed_at:type_name -> google.protobuf.Timestamp
	23, // 34: autokitteh.sessions.v1.Call.Attempt.Complete.retry_interval:type_name -> google.protobuf.Duration
	14, // 35: autokitteh.sessions.v1.Call.Attempt.Complete.result:type_name -> autokitteh.sessions.v1.Call.Attempt.Result
	21, // 36: autokitteh.sessions.v1.Session.InputsEntry.value:type_name -> autokitteh.values.v1.Value
...
func file_autokitteh_sessions_v1_session_proto_init() {
	...
	file_autokitteh_sessions_v1_session_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*SessionState_Created_)(nil),
		(*SessionState_Running_)(nil),
		(*SessionState_Error_)(nil),
		(*SessionState_Completed_)(nil),
	}
	file_autokitteh_sessions_v1_session_proto_msgTypes[2].OneofWrappers = []interface{}{
		(*SessionLogRecord_Print)(nil),
		(*SessionLogRecord_CallSpec)(nil),
		(*SessionLogRecord_CallAttemptStart)(nil),
		(*SessionLogRecord_CallAttemptComplete)(nil),
		(*SessionLogRecord_State)(nil),
	}
	file_autokitteh_sessions_v1_session_proto_msgTypes[13].OneofWrappers = []interface{}{
		(*Call_Attempt_Result_Value)(nil),
		(*Call_Attempt_Result_Error)(nil),
	}
	type x struct{}
