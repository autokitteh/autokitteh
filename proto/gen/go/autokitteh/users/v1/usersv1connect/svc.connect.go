...
const (
	...
	UsersServiceDeleteProcedure = "/autokitteh.users.v1.UsersService/Delete"
...
// Delete calls autokitteh.users.v1.UsersService.Delete.
...
func (UnimplementedUsersServiceHandler) Delete(context.Context, *connect.Request[v1.DeleteRequest]) (*connect.Response[v1.DeleteResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("autokitteh.users.v1.UsersService.Delete is not implemented"))
}
