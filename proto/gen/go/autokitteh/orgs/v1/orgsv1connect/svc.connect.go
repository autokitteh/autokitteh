...
const (
	...
	// OrgsServiceListUserMembershipsProcedure is the fully-qualified name of the OrgsService's
	// ListUserMemberships RPC.
	OrgsServiceListUserMembershipsProcedure = "/autokitteh.orgs.v1.OrgsService/ListUserMemberships"
)
...
type OrgsServiceClient interface {
	...
	ListUserMemberships(context.Context, *connect.Request[v1.ListUserMembershipsRequest]) (*connect.Response[v1.ListUserMembershipsResponse], error)
}
...
func NewOrgsServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) OrgsServiceClient {
	...
	return &orgsServiceClient{
		...
		listUserMemberships: connect.NewClient[v1.ListUserMembershipsRequest, v1.ListUserMembershipsResponse](
			httpClient,
			baseURL+OrgsServiceListUserMembershipsProcedure,
			opts...,
		),
	}
}
...
type orgsServiceClient struct {
	...
	listUserMemberships *connect.Client[v1.ListUserMembershipsRequest, v1.ListUserMembershipsResponse]
}
...
// ListUserMemberships calls autokitteh.orgs.v1.OrgsService.ListUserMemberships.
func (c *orgsServiceClient) ListUserMemberships(ctx context.Context, req *connect.Request[v1.ListUserMembershipsRequest]) (*connect.Response[v1.ListUserMembershipsResponse], error) {
...
func NewOrgsServiceHandler(svc OrgsServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	orgsServiceListUserMembershipsHandler := connect.NewUnaryHandler(
		OrgsServiceListUserMembershipsProcedure,
	...
	return "/autokitteh.orgs.v1.OrgsService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		case OrgsServiceListUserMembershipsProcedure:
			orgsServiceListUserMembershipsHandler.ServeHTTP(w, r)
		default:
			http.NotFound(w, r)
		}
	})
...
func (UnimplementedOrgsServiceHandler) ListUserMemberships(context.Context, *connect.Request[v1.ListUserMembershipsRequest]) (*connect.Response[v1.ListUserMembershipsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("autokitteh.orgs.v1.OrgsService.ListUserMemberships is not implemented"))
}
