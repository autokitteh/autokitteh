...
type DispatchRequest struct {
	...
	Project      string    `protobuf:"bytes,3,opt,name=project,proto3" json:"project,omitempty"` // either project id or name.
	Wait         bool      `protobuf:"varint,4,opt,name=wait,proto3" json:"wait,omitempty"`      // if true, the call will block until the dispatch is done.
}
...
func (x *DispatchRequest) GetWait() bool {
	if x != nil {
		return x.Wait
	}
	return false
...
type DispatchResponse struct {
	...
	StartedSessionIds  []string `protobuf:"bytes,2,rep,name=started_session_ids,json=startedSessionIds,proto3" json:"started_session_ids,omitempty"`    // only if wait
	SignaledSessionIds []string `protobuf:"bytes,3,rep,name=signaled_session_ids,json=signaledSessionIds,proto3" json:"signaled_session_ids,omitempty"` // only if wait
}
...
func (x *DispatchResponse) GetStartedSessionIds() []string {
	if x != nil {
		return x.StartedSessionIds
	}
	return nil
}

func (x *DispatchResponse) GetSignaledSessionIds() []string {
	if x != nil {
		return x.SignaledSessionIds
	}
	return nil
}
...
func (x *RedispatchRequest) GetWait() bool {
	if x != nil {
		return x.Wait
	}
	return false
...
func (x *RedispatchResponse) GetStartedSessionIds() []string {
	if x != nil {
		return x.StartedSessionIds
	}
	return nil
...
func (x *RedispatchResponse) GetSignaledSessionIds() []string {
	if x != nil {
		return x.SignaledSessionIds
	}
	return nil
...
var file_autokitteh_dispatcher_v1_svc_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	,
	...
	,
