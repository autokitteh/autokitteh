...
ALTER TABLE "projects" ADD COLUMN "created_by" uuid NULL, ADD COLUMN "created_at" timestamptz NULL, ADD COLUMN "org_id" uuid NOT NULL, ADD COLUMN "updated_by" uuid NULL, ADD COLUMN "updated_at" timestamptz NULL;
...
-- modify "vars" table
ALTER TABLE "vars" ADD COLUMN "created_by" uuid NULL, ADD COLUMN "created_at" timestamptz NULL, ADD COLUMN "project_id" uuid NOT NULL, ADD COLUMN "updated_by" uuid NULL, ADD COLUMN "updated_at" timestamptz NULL, ADD
