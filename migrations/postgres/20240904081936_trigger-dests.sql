...
-- modify "events" table
ALTER TABLE "events" ADD COLUMN "destination_id" uuid NOT NULL, ADD COLUMN "trigger_id" uuid NULL, ADD
...
ALTER TABLE "signals" ALTER COLUMN "signal_id" TYPE uuid, ALTER COLUMN "connection_id" DROP NOT NULL, ADD COLUMN "destination_id" uuid NOT NULL, ADD COLUMN "trigger_id" uuid NULL, ADD
