...
ALTER TABLE "projects" ADD COLUMN "created_by" uuid NOT NULL, ADD COLUMN "created_at" timestamptz NULL, ADD COLUMN "org_id" uuid NOT NULL, ADD COLUMN "updated_by" uuid NULL, ADD COLUMN "updated_at" timestamptz NULL, ADD
 CONSTRAINT "fk_projects_project" FOREIGN KEY ("project_id") REFERENCES "projects" ("project_id") ON UPDATE NO ACTION ON DELETE NO ACTION;
...
-- modify "events" table
ALTER TABLE "events" ADD COLUMN "created_by" uuid NOT NULL, ADD COLUMN "project_id" uuid NOT NULL, ADD
...
ALTER TABLE "projects" DROP CONSTRAINT "fk_projects_project", DROP COLUMN "updated_at", DROP COLUMN "updated_by", DROP COLUMN "org_id", DROP COLUMN "created_at", DROP COLUMN "created_by";
