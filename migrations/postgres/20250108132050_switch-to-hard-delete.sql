...
ALTER TABLE "events" DROP CONSTRAINT "fk_events_connection", DROP CONSTRAINT "fk_events_project", DROP CONSTRAINT "fk_events_trigger", DROP COLUMN "deleted_at", ADD
 CONSTRAINT "fk_events_connection" FOREIGN KEY ("connection_id") REFERENCES "connections" ("connection_id") ON UPDATE NO ACTION ON DELETE CASCADE DEFERRABLE, ADD
 ...
 CONSTRAINT "fk_events_trigger" FOREIGN KEY ("trigger_id") REFERENCES "triggers" ("trigger_id") ON UPDATE NO ACTION ON DELETE CASCADE DEFERRABLE;
...
ALTER TABLE "sessions" DROP CONSTRAINT "fk_sessions_build", DROP CONSTRAINT "fk_sessions_deployment", DROP CONSTRAINT "fk_sessions_event", DROP CONSTRAINT "fk_sessions_project", DROP COLUMN "deleted_at", ADD
 ...
 CONSTRAINT "fk_sessions_event" FOREIGN KEY ("event_id") REFERENCES "events" ("event_id") ON UPDATE NO ACTION ON DELETE CASCADE DEFERRABLE, ADD
