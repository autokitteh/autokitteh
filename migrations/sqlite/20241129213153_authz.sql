...
-- add column "created_by" to table: "builds"
ALTER TABLE `builds` ADD COLUMN `created_by` uuid NOT NULL;
-- add column "owner_id" to table: "builds"
ALTER TABLE `builds` ADD COLUMN `owner_id` uuid NOT NULL;
-- add column "owner_user_id" to table: "builds"
ALTER TABLE `builds` ADD COLUMN `owner_user_id` uuid NOT NULL;
-- add column "owner_org_id" to table: "builds"
ALTER TABLE `builds` ADD COLUMN `owner_org_id` uuid NOT NULL;
...
-- add column "owner_id" to table: "projects"
...
-- add column "owner_org_id" to table: "projects"
ALTER TABLE `projects` ADD COLUMN `owner_org_id` uuid NOT NULL;
...
-- add column "created_by" to table: "sessions"
ALTER TABLE `sessions` ADD COLUMN `created_by` uuid NOT NULL;
-- add column "owner_id" to table: "sessions"
...
-- add column "owner_org_id" to table: "sessions"
ALTER TABLE `sessions` ADD COLUMN `owner_org_id` uuid NOT NULL;
-- add column "updated_by" to table: "sessions"
ALTER TABLE `sessions` ADD COLUMN `updated_by` uuid NULL;
...
-- reverse: add column "updated_by" to table: "sessions"
ALTER TABLE `sessions` DROP COLUMN `updated_by`;
-- reverse: add column "owner_org_id" to table: "sessions"
ALTER TABLE `sessions` DROP COLUMN `owner_org_id`;
-- reverse: add column "owner_user_id" to table: "sessions"
ALTER TABLE `sessions` DROP COLUMN `owner_user_id`;
-- reverse: add column "owner_id" to table: "sessions"
ALTER TABLE `sessions` DROP COLUMN `owner_id`;
-- reverse: add column "created_by" to table: "sessions"
...
-- reverse: add column "owner_org_id" to table: "projects"
ALTER TABLE `projects` DROP COLUMN `owner_org_id`;
-- reverse: add column "owner_user_id" to table: "projects"
ALTER TABLE `projects` DROP COLUMN `owner_user_id`;
-- reverse: add column "owner_id" to table: "projects"
...
-- reverse: add column "owner_org_id" to table: "builds"
ALTER TABLE `builds` DROP COLUMN `owner_org_id`;
-- reverse: add column "owner_user_id" to table: "builds"
ALTER TABLE `builds` DROP COLUMN `owner_user_id`;
-- reverse: add column "owner_id" to table: "builds"
ALTER TABLE `builds` DROP COLUMN `owner_id`;
-- reverse: add column "created_by" to table: "builds"
ALTER TABLE `builds` DROP COLUMN `created_by`;
