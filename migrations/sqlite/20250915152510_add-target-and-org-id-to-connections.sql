...
-- add column "target" to table: "connections"
ALTER TABLE `connections` ADD COLUMN `target` text NULL;
...
-- reverse: add column "target" to table: "connections"
ALTER TABLE `connections` DROP COLUMN `target`;
