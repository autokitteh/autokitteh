...
INSERT INTO `new_builds` (`created_at`, `build_id`, `project_id`, `data`, `deleted_at`) SELECT `created_at`, `build_id`, `project_id`, `data`, `deleted_at` FROM `builds`;
...
INSERT INTO `new_sessions` (`created_at`, `session_id`, `build_id`, `project_id`, `deployment_id`, `event_id`, `current_state_type`, `entrypoint`, `inputs`, `memo`, `updated_at`, `deleted_at`) SELECT `created_at`, `session_id`, `build_id`, `project_id`, `deployment_id`, `event_id`, `current_state_type`, `entrypoint`, `inputs`, `memo`, `updated_at`, `deleted_at` FROM `sessions`;
